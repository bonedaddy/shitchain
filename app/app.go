...
import (
	...
	"github.com/bonedaddy/shitchain/docs"
)
...
func New(
	...
	*/
	...
	app.ShitchainKeeper = *shitchainmodulekeeper.NewKeeper(
		appCodec,
		keys[shitchainmoduletypes.StoreKey],
		keys[shitchainmoduletypes.MemStoreKey],
		app.GetSubspace(shitchainmoduletypes.ModuleName),
	)
