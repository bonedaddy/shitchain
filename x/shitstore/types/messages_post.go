...
func NewMsgCreatePost(creator string, title string, body string, amount sdk.Coin, tags []string) *MsgCreatePost {
...
func NewMsgUpdatePost(creator string, id uint64, title string, body string, amount sdk.Coin, tags []string) *MsgUpdatePost {
