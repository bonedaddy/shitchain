...
// source: shitchain/shitchain/thread.proto
...
func (*Thread) Descriptor() ([]byte, []int) {
	return fileDescriptor_abf3e2a124c5e2e7, []int{0}
}
...
func init() {
	proto.RegisterType((*Thread)(nil), "shitchain.shitchain.Thread")
}

func init() { proto.RegisterFile("shitchain/shitchain/thread.proto", fileDescriptor_abf3e2a124c5e2e7) }

var fileDescriptor_abf3e2a124c5e2e7 = []byte{
	// 192 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Thread) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Body) > 0 {
		i -= len(m.Body)
		copy(dAtA[i:], m.Body)
		i = encodeVarintThread(dAtA, i, uint64(len(m.Body)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Title) > 0 {
		i -= len(m.Title)
		copy(dAtA[i:], m.Title)
		i = encodeVarintThread(dAtA, i, uint64(len(m.Title)))
		i--
		dAtA[i] = 0xa
	}
